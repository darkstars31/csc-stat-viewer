import{i as y,k as d,u as h,r as u,l as p,j as r,E as g,L as b}from"./index-CS1wzTC4.js";const S=1e3*60*60,f=async(o,s)=>await fetch(d.endpoints.cscGraphQL.stats,{method:"POST",body:JSON.stringify({operationName:"ProfileTrendGraph",query:`query ProfileTrendGraph($steamId: BigInt!, $season: Int!) {
