	...
	const seriesArray: (BarSeriesType | LineSeriesType)[] = [
		{
			...
			emphasis: { focus: "series" },
			data: [
				getByRoleAndTier("RIFLER", "Recruit"),
		...
		},
		{
			...
			emphasis: { focus: "series" },
			data: [
				getByRoleAndTier("AWPER", "Recruit"),
		...
		},
		{
			...
			emphasis: { focus: "series" },
			data: [
				getByRoleAndTier("SUPPORT", "Recruit"),
		...
		},
		{
			...
			emphasis: { focus: "series" },
			data: [
				getByRoleAndTier("FRAGGER", "Recruit"),
		...
		},
		{
			...
			emphasis: { focus: "series" },
			data: [
				getByRoleAndTier("ENTRY", "Recruit"),
	...
	return (
		<>
			...
			<Containers.StandardContentBox>
				<ReactECharts
					key={showProportions ? "proportions" : "totals"}
					className="w-full pr-4"
					option={optionPlayersInTier}
					style={{ height: 500 }}
				/>
			</Containers.StandardContentBox>
		</>
