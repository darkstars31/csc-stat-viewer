...
export function Chickens() {
    ...
    const smokeKillLeaderBoard = playersWithExtendedStats.sort( (a, b) => (b?.extendedStats.trackedObj.smokeKills) - (a.extendedStats?.trackedObj.smokeKills) ).slice(0, 10);
    ...
    return (
        <Container>
                ...
                <div className='flex flex-row flex-wrap m-auto'>
                    ...
                    <LeaderBoard title='Smoke Kills' property='smokeKills' leaderBoard={smokeKillLeaderBoard} />
