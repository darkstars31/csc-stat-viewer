            ...
            <div className="mx-auto max-w-xlg">
                ...
                <div className="mt-4 text-gray-300">
                    ...
                    <div>
                        ...
                        <a className="inline" href='https://ko-fi.com/L4L310VRKM' target='_blank'><img height='36' style={{border:'0px',height:'36px'}} src='https://storage.ko-fi.com/cdn/kofi3.png?v=3' alt='Buy Me a Coffee at ko-fi.com' /></a>
                    </div>
                    <div className="pt-4">
                        <h3>Contributors</h3>
