...
export function Hitbox ( { hitboxTags }: { hitboxTags: ExtendedStats["hitboxTags"] } ) {
    ...
    const totalHitboxTags = Object.values(hitboxTags).reduce(( cumulative, hitboxTag ) => cumulative + hitboxTag, 0) - hitboxTags.Generic;
    ...
    return (
        <>
            <div className="relative text-sm font-bold h-80 m-1">
                ...
                <img className={`absolute object-cover left-[4px] top-[4px] min-h-[329px] min-w-[329px]`} src={tpose} alt="tpose" />
                <div className={`absolute left-[120px] ${hitboxValuePercentages.head}`}>Head {hitboxPercentages.head}%</div>
                <div className={`absolute left-[10px] top-[48px] ${hitboxValuePercentages.rightArm}`}>Right Arm {hitboxPercentages.rightArm}%</div>
                <div className={`absolute left-[212px] top-[48px] ${hitboxValuePercentages.leftArm}`}>Left Arm {hitboxPercentages.leftArm}%</div>
                <div className={`absolute left-[148px] top-[80px] text-center ${hitboxValuePercentages.chest}`}><div>Chest</div>{hitboxPercentages.chest}%</div>
                <div className={`absolute left-[120px] top-[148px] ${hitboxValuePercentages.stomach}`}>Stomach {hitboxPercentages.stomach}%</div>
                <div className={`absolute left-[40px] top-[220px] ${hitboxValuePercentages.rightLeg}`}>Right Leg {hitboxPercentages.rightLeg}%</div>
                <div className={`absolute left-[183px] top-[241px] ${hitboxValuePercentages.leftLeg}`}>Left Leg {hitboxPercentages.leftLeg}%</div>
                
                <img onMouseOver={() => setShowInfo("Head")} onMouseOut={() => setShowInfo(null)} style={{filter: "url(#greenOverlay)"}} className={`absolute left-[90px] top-[13px] ${getClassNamesOnPercentage(hitboxPercentages.head)}`} src={head} alt="tpose" />
                <img onMouseOver={() => setShowInfo("RightArm")} onMouseOut={() => setShowInfo(null)} style={{filter: "url(#redOverlay)"}} className={`absolute left-[5px] top-[61px] ${getClassNamesOnPercentage(hitboxPercentages.rightArm)}`} src={rightArm} alt="tpose" />
                <img onMouseOver={() => setShowInfo("LeftArm")} onMouseOut={() => setShowInfo(null)} className={`absolute left-[203px] top-[64px] ${getClassNamesOnPercentage(hitboxPercentages.leftArm)}`} src={leftArm} alt="tpose" />
                <img onMouseOver={() => setShowInfo("Chest")} onMouseOut={() => setShowInfo(null)} className={`absolute left-[134px] top-[64px] ${getClassNamesOnPercentage(hitboxPercentages.chest)}`} src={chest} alt="tpose" />
                <img onMouseOver={() => setShowInfo("Stomach")} onMouseOut={() => setShowInfo(null)} className={`absolute left-[127px] top-[138px] ${getClassNamesOnPercentage(hitboxPercentages.stomach)}`} src={stomach} alt="tpose" />
                <img onMouseOver={() => setShowInfo("RightLeg")} onMouseOut={() => setShowInfo(null)} className={`absolute left-[127px] top-[184px] ${getClassNamesOnPercentage(hitboxPercentages.rightLeg)}`} src={rightLeg} alt="tpose" />
                <img onMouseOver={() => setShowInfo("LeftLeg")} onMouseOut={() => setShowInfo(null)} className={`absolute left-[169px] top-[184px] ${getClassNamesOnPercentage(hitboxPercentages.leftLeg)}`} src={leftLeg} alt="tpose" />
            </div>
            <div className="h-4">
                { showInfo && 
