...
export const GridContainer = ({ children }: { children: React.ReactNode | React.ReactNode[] }) => (
	<div className="grid grid-cols-1 bg-midnight2 rounded-lg gap-2 md:grid-cols-2">{children}</div>
);
