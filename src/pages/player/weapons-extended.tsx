            ...
            <div className='flex flex-row'>
                ...
                <div className='m-2 text-center' key={key}>
                    <div className='m-1 p-2 w-16 h-12'>
                        <ToolTip type="generic" message={key}><img src={cs2icons[subTypeImages[key as keyof typeof subTypeImages]]} alt={key} /></ToolTip>
                    </div>
                    <div>{value}</div>
                </div> 
                ) }
            ...
            <div className='flex flex-row flex-wrap'>
                ...
                <div className='m-2 text-center' key={key}>
                    <div className='m-1 p-2 w-16 h-12 -rotate-45'>
                        <ToolTip type="generic" message={key}><img src={cs2icons[key]} alt={key} /></ToolTip>
                    </div>
                    <div>{value}</div>
                </div> 
                ) }
