...
export function useCscStatsProfileGraph( steamId: string | undefined, season?: number ): UseQueryResult<{ ctRating: number, tRating: number} | undefined> {
    return useQuery( 
        [`cscstats-${steamId}-graph`], 
        () => fetchGraph( steamId, season ), 
        {
