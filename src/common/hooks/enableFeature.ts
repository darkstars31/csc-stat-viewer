...
export const useEnableFeature = ( featureString: string ) => {
    ...
    React.useEffect(() => {
        const rules = [
            { name: "canUsePlayerComparison", function: () => isIn( loggedinUser?.team?.franchise.prefix, 'V0VU') || isIn( loggedinUser?.steam64Id, ['NzY1NjExOTgxNjk5MzM4NzA=','NzY1NjExOTc5ODcwMTU0NjA=','NzY1NjExOTgxMDcxNTY4MjA=','NzY1NjExOTgzMzg1NDg0MzA='])},
        ];
