...
export function ExternalPlayerLinks( { player }: Props) {
    ...
    <div className="lg:flex justify-end">
        ...
        { !isLoadingFaceitSearch && <div className="hover:cursor-pointer text-orange-500 mx-1 bg-slate-900 p-1 rounded w-6 float-left"><a href={`https://www.faceit.com/en/players/${faceitSearchPlayer?.items[0]?.nickname}`} target="_blank" rel="noreferrer"><SiFaceit /></a></div> }
    </div>);
};