...
export const ToolsDropdown = () => {
    ...
    <Menu as="div" className="relative inline-block">
        <Menu.Button className="flex text-sm focus:outline-none px-3 py-2 rounded-md font-medium text-gray-300 hover:bg-gray-700" onClick={ () => setOpen( value => !value)}>
            Tools { open ? <MdKeyboardArrowUp size="1.5em" className='leading-8 pl-1' /> : <MdKeyboardArrowDown size="1.5em" className='leading-8 pl-1' /> }
        </Menu.Button>
        <Transition
            as={React.Fragment}
